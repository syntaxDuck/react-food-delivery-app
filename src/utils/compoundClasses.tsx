...
export const compoundClasses = {
  ...
  navigation: {
    ...
    mobileMenu: 'fixed top-0 right-0 h-full w-80 bg-gradient-to-r from-gray-900/95 via-gray-800/92 to-gray-900/95 backdrop-blur-md border-l border-white/10 shadow-[0_12px_40px_rgba(0,0,0,0.35)] z-mobile-menu md:hidden',
