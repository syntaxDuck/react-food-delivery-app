...
export const getActiveItemClass = (isActive) => {
  return isActive 
...
export const getMobileActiveItemClass = (isActive) => {
  return isActive 
...
export const handleNavigationClick = (menuElement, setActiveSection, toggleMobileMenu) => {
